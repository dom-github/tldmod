...
reward_birds_wb = [ 
	...
	(try_begin), #Spawn appropriate bird prop 
		...
		(try_begin),
            ...
            (try_begin),
                (player_has_item, "itm_crebain_reward"), #if they have both items they only get this one - I'm assuming players never have both 
                (assign, "$birdprop", "spr_birds_crebain"), 
            (else_try),
                (player_has_item, "itm_thrush_reward"),
    ...
    (0.1, 0, ti_once,  #change refresh rate to alter wing speed - copy trigger for separate bird speeds 
    [
